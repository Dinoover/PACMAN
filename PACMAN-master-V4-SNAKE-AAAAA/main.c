...
int main(int argc, char *argv[])
{
    ...
    int terrain = 4;///VARIABLE QUI CHOISIT LE NUMERO DU TERRAIN (A METTRE DANS UN PROG)
    ...
    while(fin!=1)
    {
        ...
        {
            game_over = game_over + snake(&pac,fan,next_dep,laby);
        }
        ...
        gotoligcol(16,40);
        printf("oldx = %d oldy = %d ",pac.oldx,pac.oldy);
        gotoligcol(17,40);
